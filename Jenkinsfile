    ...
    stages {
        ...
        stage('deploy') {
            steps {
                ...
                sh "scp /home/slave1/workspace/parcelservice_feature-1/target/simple-parcel-service-app-1.0-SNAPSHOT.jar root@172.31.42.29:/opt/apache-tomcat-8.5.98/webapps/"
            }
        }
